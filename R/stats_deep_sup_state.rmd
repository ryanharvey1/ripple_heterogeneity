...
data <- data[data$ca1_layer != "Middle" & data$spikeCount > 200,]
data <- data[data$ca1_layer == "Deep" | data$ca1_layer == "Superficial",]
data <- data[data$putativeCellType  == "Pyramidal Cell",]
