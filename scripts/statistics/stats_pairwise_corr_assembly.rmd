...
```{r}
data <- read.csv('Z:/home/ryanh/projects/ripple_heterogeneity/assembly_unit_corrs_rem_shift/results/df.csv')
...
m1 = lmer(rho_trans ~ simple_effect + (1 | name/assembly_id), data = data_2,REML=FALSE)
summary(m1)
